        ...
        <form data-test='search-form' className="text-sm" onSubmit={handleSubmit}>
            ...
            <fieldset className="mb-4">
                ...
                <label className="-mt-3.5 cursor-pointer">
                    ...
                    <input data-test='screen-name-input' onChange={handleChange} defaultValue={formState.screenName} className="bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg" name='screenName' />
                </label>
                <label className="-mt-3.5 cursor-pointer">
