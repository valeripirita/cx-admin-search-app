        ...
        <form className={'text-sm'} onSubmit={handleSubmit}>
            ...
            <fieldset className={'mb-6'}>
                <label className={'-mt-3.5 cursor-pointer'}>
                    ...
                    <select name='jurisdiction' className={'bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg'}>
            ...
            <fieldset className={'mb-6'}>
                <hr className={'border-t-neutral-300 my-3.5'} />
                <label className={'-mt-3.5 cursor-pointer'}>
                    <p className={'inline-block text-stone-600 bg-stone-100 p-1 translate-x-3.5 translate-y-3.5'}>Member ID</p>
                    <input className={'bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg'} name='memberId' />
                </label>
                <label className={'-mt-3.5 cursor-pointer'}>
                    <p className={'inline-block text-stone-600 bg-stone-100 p-1 translate-x-3.5 translate-y-3.5'}>Email</p>
                    <input className={'bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg'} name='email' />
                </label>
                <label className={'-mt-3.5 cursor-pointer'}>
                    <p className={'inline-block text-stone-600 bg-stone-100 p-1 translate-x-3.5 translate-y-3.5'}>Postcode</p>
                    <input className={'bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg'} name='postcode' />
                </label>
                <label className={'-mt-3.5 cursor-pointer'}>
                    <p className={'inline-block text-stone-600 bg-stone-100 p-1 translate-x-3.5 translate-y-3.5'}>Phone</p>
                    <input className={'bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg'} name='phone' />
                </label>
            </fieldset>
            <fieldset className={'mb-6'}>
                <hr className={'border-t-neutral-300 my-3.5'} />
                <label className={'-mt-3.5 cursor-pointer'}>
                    ...
                    {/*FIXME: select arrow is too close to edge*/}
                    <select name='venture' className={'bg-stone-100 block py-2.5 px-3 border border-neutral-400 rounded-lg'}>
                        {/*FIXME: get jurisdiction names from somewhere or at least move them to a list*/}
            ...
            <button className={'uppercase bg-blue-700 text-white w-full p-3.5 rounded-lg'} type='submit'>Search</button>
        </form>
    );
};
